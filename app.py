...
if view_mode == "court" and court_id:
    ...
    st.markdown(f"""<div style="background-color: #006030; color: #ffffff; padding: 25px; border-radius: 12px; border-left: 10px solid #5c2d91; box-shadow: 0 4px 6px rgba(0,0,0,0.3); font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;"><div style="border-bottom: 2px solid #5c2d91; padding-bottom: 10px; margin-bottom: 20px; display: flex; align-items: center; justify-content: space-between;"><div style="display: flex; align-items: center;"><span style="font-size: 1.5em; margin-right: 10px;">🎾</span><span style="font-size: 1.3em; font-weight: bold; color: #ccff00;">OFFICIAL SCHEDULE</span></div><div style="background-color: #5c2d91; color: #fff; padding: 5px 10px; border-radius: 5px; font-weight: bold; font-size: 0.9em;">START: {start_time_str}</div></div><div style="display: grid; grid-template-columns: 110px 1fr; gap: 10px; align-items: center;"><div style="text-align: right; font-weight: bold; color: #ccff00; padding-right: 10px; border-right: 2px solid #5c2d91;">08:10 ~ 09:00</div><div style="background-color: rgba(255,255,255,0.1); padding: 8px 12px; border-radius: 5px;">🏟️ 개막식 <span style="font-size:0.8em; color:#ccc; margin-left:5px;">(코트 2개 사용)</span></div><div style="text-align: right; font-weight: bold; color: #ccff00; padding-right: 10px; border-right: 2px solid #5c2d91;">09:00 ~ 12:30</div><div style="background-color: rgba(255,255,255,0.1); padding: 8px 12px; border-radius: 5px;">🔥 예선 경기 <span style="font-size:0.8em; color:#ccc; margin-left:5px;">(09:00 첫 경기 시작)</span></div><div style="text-align: right; font-weight: bold; color: #ccff00; padding-right: 10px; border-right: 2px solid #5c2d91;">12:00 ~ </div><div style="background-color: rgba(255,255,255,0.1); padding: 8px 12px; border-radius: 5px;">🥪 점심 식사 <span style="font-size:0.8em; color:#ccc; margin-left:5px;">(식사 제공 시작)</span></div><div style="text-align: right; font-weight: bold; color: #ccff00; padding-right: 10px; border-right: 2px solid #5c2d91;">12:30 ~ 13:10</div><div style="background-color: rgba(255,255,255,0.1); padding: 8px 12px; border-radius: 5px;">📋 예선 종료 및 대진 정리</div><div style="text-align: right; font-weight: bold; color: #ccff00; padding-right: 10px; border-right: 2px solid #5c2d91;">13:10 ~ 14:30</div><div style="background-color: rgba(255,255,255,0.1); padding: 8px 12px; border-radius: 5px;">🏆 본선 32강</div><div style="text-align: right; font-weight: bold; color: #ccff00; padding-right: 10px; border-right: 2px solid #5c2d91;">14:30 ~ 15:10</div><div style="background-color: rgba(255,255,255,0.1); padding: 8px 12px; border-radius: 5px;">🎾 16강전</div><div style="text-align: right; font-weight: bold; color: #ccff00; padding-right: 10px; border-right: 2px solid #5c2d91;">15:10 ~ 16:00</div><div style="background-color: rgba(255,255,255,0.1); padding: 8px 12px; border-radius: 5px;">🎾 8강전</div><div style="text-align: right; font-weight: bold; color: #ccff00; padding-right: 10px; border-right: 2px solid #5c2d91;">16:00 ~ 16:40</div><div style="background-color: rgba(255,255,255,0.1); padding: 8px 12px; border-radius: 5px;">🥉 4강전</div><div style="text-align: right; font-weight: bold; color: #ccff00; padding-right: 10px; border-right: 2px solid #5c2d91;">16:40 ~ </div><div style="background-color: rgba(255,255,255,0.1); padding: 8px 12px; border-radius: 5px;">🥇 결승전 <span style="font-size:0.8em; color:#ccc; margin-left:5px;">(시상식 및 폐회)</span></div></div><div style="margin-top: 15px; font-size: 0.85em; color: #aaa; text-align: center;">* 경기 상황에 따라 시간이 변동될 수 있습니다.</div></div>""", unsafe_allow_html=True)
